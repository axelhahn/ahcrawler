...
function modalDlg_setTitle(a=""){document.getElementById("dialogtitle").innerHTML=a?a:"&nbsp;"}function modalDlg_setContent(a=""){document.getElementById("dialogcontent").innerHTML=a}function showModalUrl(a,b=""){showModal('<iframe src="'+a+'" style="width: 100%; border: 0; height: 800px;"></iframe>',b)}function showModal(a="",b=""){modalDlg_setTitle(b);modalDlg_setContent(a);showModalWindow(!0)}
...
function updateStatus(a){var b=document.getElementById("divStatus");fetch(a,{}).then(a=>a.text()).then(c=>{b.innerHTML=c;b.style.display=c?"inline":"none";window.setTimeout('updateStatus("'+a+'")',1E3*(c?1:10))})}function initBase64Input(a,b){var c=document.getElementById(a),d=document.getElementById(b);c&&d&&(c=document.getElementById(a),c.onchange=function(){d.value=btoa(c.value);console.log("IN: "+c.value+" | OUT: "+d.value)})}
